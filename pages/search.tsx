...
const Search = ({ results }) => {
  ...
  return (
    <div className="app" ref={appDiv}>
      <Head>
        <title>{router.query.q} - Google Search Clone</title>
        <link
          rel="icon"
      ...
      <main className={styles.searchMain}>
        ...
        <ul className={styles.options}>
          <li className={`icon ${styles.icon} ${styles.active}`}>
            <DocumentSearchIcon /> <span>tout</span>
          </li>
          ...
          <li className={`icon ${styles.icon}`}>
            <CogIcon /> <span>Option de recherche</span>
          </li>
        </ul>

        <span className={styles.time}>
         A propos {results?.searchInformation?.formattedTotalResults} résultats en{' '}
          {results?.searchInformation?.searchTime} secondes
        </span>
